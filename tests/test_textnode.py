...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_node_to_html_node_TEXT(self):
        ...
        expected = HTMLNode(
            tag=None, value="This is just text", children=None, props=None
        )
        ...
        expected = HTMLNode(
            tag="b", value="This is bold text", children=None, props=None
        )
        self.assertEqual(actual, expected)
        ...
        expected = HTMLNode(
            ...
            value="",
            children=None,
            props={"alt": "This is an image", "src": "example.com"},
        )
        self.assertEqual(actual, expected)

    def test_non_existent_node_raises_exception(self):
        self.assertRaises(
            ValueError, TextNode, "This is a text", TextTypeWithError.ERROR
        )
