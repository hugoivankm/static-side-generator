...
class TestMarkdownParser(unittest.TestCase):
    ...
    def test_split__node_delimiter_should_work_with_node_bold_element_before_code_element(
        self,
    ):
        actual_list = MarkdownParser.split_nodes_delimiter(
            [
    ...
    def test_split__node_delimiter_should_work_with_italic_element_after_code_element(
        self,
    ):
        actual_list = MarkdownParser.split_nodes_delimiter(
            [
    ...
    def test_extract_title_should_return_valid_h1_header_even_if_not_in_first_line(
        self,
    ):
        markdown = """
        ** Some bold text** :D
